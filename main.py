...
def get_developer_stats(desarrollador: str):
    ...
    df = pd.read_parquet(r'C:\Users\Usuario\Desktop\proyecto steam\Data Exportada\user_games_clean.parquet')
...
def get_user_data(User_id: str):
    ...
    df_items = pd.read_parquet(r'C:\Users\Usuario\Desktop\proyecto steam\Data Exportada\user_items_clean.parquet')
...
def developer_reviews_analysis(desarrollador: str):
    ...
    sentiment = pd.read_parquet(r'C:\Users\Usuario\Desktop\proyecto steam\Sentiment_analysis\Sentiment_Analysis_parquet')
...
#                                       CONSULTA 4 
#-------------------------------------------------------------------------------------
df_merged = pd.read_parquet(r'C:\Users\Usuario\Desktop\proyecto steam\Data Exportada\df_marged.parquet')
